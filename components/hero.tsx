...
return (
  <section
    ...
    role="banner"
    aria-label="V Design Studio - Architecture and Interior Design"
  >
    {/* Background Video */}
    <div className="absolute inset-0 w-full h-full">
      ...
      {/* ✅ Full-section black overlay for cinematic effect */}
...
>
  ARCHITECTURE & INTERIOR DESIGN
        ...
        <motion.p
          ...
          className="font-['Playfair_Display'] text-xl md:text-2xl max-w-2xl mx-auto leading-relaxed blink-text-subtitle text-[#f5f5f5] px-6  rounded-md "
          style={{
            textShadow:
              "0 2px 4px rgba(0, 0, 0, 0.5), 0 4px 10px rgba(0, 0, 0, 0.4)",
          }}
          role="doc-subtitle"
        >
          Crafting Timeless Spaces Through Architectural Excellence & Interior Innovation
        </motion.p>
        ...
        <motion.p
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 0.8 }}
          className="font-['Cinzel'] text-lg tracking-widest text-[#f5f5f5] px-4 rounded-md "
          style={{
            textShadow:
